      ...
      <section className="flex justify-center md:w-2/6 xl:w-1/5">
        ...
        <SignedOut>
          ...
          <SignInButton mode="modal">
            <button className="py-1 xl:w-80 xl:py-4">
              <p className="xl:mt-6 mb-12 xl:mb-0 text-lg uppercase after:block after:content-[''] after:border-b-2 after:border-b-ic8 after:scale-x-0 after:transform after:duration-200 after:ease-in-out after:py-2 hover:after:scale-x-100 hover:after:py-2 md:mb-0 md:mt-4">
                Client Portal
              </p>
            </button>
          </SignInButton>
