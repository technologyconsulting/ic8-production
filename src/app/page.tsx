...
export default function Home() {
  return (
    <main className="relative m-auto flex h-fit w-full min-w-20 flex-col bg-black text-ic8 xl:w-4/5 xl:max-w-screen-xl">
      ...
      {/* PEOPLE */}
      <section className="m-auto flex w-full min-w-20 max-w-screen-xl flex-col gap-16 bg-black text-ic8 md:gap-4 landscape:mt-12 landscape:gap-0 landscape:md:m-auto landscape:lg:min-h-fit">
        {/* TITLE */}
        <h2
          id="people"
        ...
        {/* SPENCER SHALKA */}
        <section className="flex flex-col gap-12 md:items-center md:gap-0 lg:my-12 xl:my-0 xl:mt-12 xl:h-fit xl:flex-row xl:gap-8 xl:rounded-s-full xl:border-none landscape:gap-0 landscape:md:gap-12">
          {/* NAME & IMAGE */}
          <div className="flex h-56 flex-col md:flex-row md:items-center md:gap-12 xl:w-3/6 xl:flex-row xl:justify-between xl:gap-4 xl:rounded-e-full xl:rounded-l-xl xl:border-none xl:bg-neutral-950 xl:drop-shadow-white landscape:flex-row">
        ...
        {/* TIM HATHAWAY */}
        <section className="mt-8 flex min-h-fit flex-col-reverse md:items-center lg:my-12 xl:my-0 xl:mb-12 xl:h-fit xl:flex-row xl:gap-8 xl:rounded-e-full xl:border-none landscape:mt-8 landscape:gap-0 landscape:md:gap-12">
          {/* BIO */}
          ...
          {/* NAME & IMAGE */}
          <div className="flex h-56 flex-col-reverse md:flex-row md:items-center md:gap-12 xl:w-3/6 xl:flex-row xl:justify-between xl:gap-4 xl:rounded-e-2xl xl:rounded-s-full xl:border-none xl:bg-neutral-950 xl:drop-shadow-white landscape:flex-row landscape:justify-end">
